...
# Load .env variables
load_dotenv()
api_base = os.getenv("OLLAMA_API_BASE", "http://38.29.145.24:40044")
...
def ollama_request(
    ...
    Args:
        ...
        api_base_url: Base URL for Ollama API (defaults to env variable or localhost)
    ...
    if messages and isinstance(messages, list) and all(isinstance(m, dict) for m in messages):
